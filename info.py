...
BOT_TOKEN = environ.get('BOT_TOKEN', '5834315400:AAHtL6C2vD8NK8CXXeV0qVQah9LOmSeOPj0')
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1001879503848")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002032875531))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'BugFilmsSupport')
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📂 File Name</b>: <code> {caption} </code>\n\n<b>❤️‍🔥 Bot @AlaaskaBot</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Hᴇʏ {message.from_user.mention}, Hᴇʀᴇ ɪs Wʜᴀᴛ I Fᴏᴜɴᴅ Iɴ Mʏ Dᴀᴛᴀʙᴀsᴇ Fᴏʀ Yᴏᴜʀ Qᴜᴇʀʏ {search}.</b>")
